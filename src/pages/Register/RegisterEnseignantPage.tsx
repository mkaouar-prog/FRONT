// src/pages/Register/RegisterEnseignantPage.tsx
...
import { useRegisterEnseignant } from '../../hooks/useRegisterEnseignant';
import { useNavigate, Link } from 'react-router-dom';

const { Option } = Select;

const RegisterEnseignantPage: React.FC = () => {
  ...
  const [sousCategorie, setSousCategorie] = useState(''); // Optional for enseignant
  ...
  // Custom hook for enseignant registration
  const { registerEnseignant, loading, apiError } = useRegisterEnseignant();
  ...
  // For enseignant, the "Sous Catégorie" options (optional) when category is Faculté
  const enseignantSousOptions = ["Option A", "Option B", "Option C"];
  ...
  const formSections = [
    ...
    },
    {
      ...
      fields: ["stateTunisia", "categorie", "niveau", "sousCategorie", "yearsOfExperience", "additionalInfo"]
    },
    {
      title: "Sécurité",
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const result = await registerEnseignant(data);
    if (result) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="relative z-20 p-12 flex flex-col justify-center h-full text-white">
              ...
              >
                ...
                <p className="text-lg opacity-90 mb-6">
                  Rejoignez notre communauté d'enseignants et commencez à inspirer la prochaine génération.
                </p>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <span>Faites grandir vos compétences</span>
                  </div>
                </div>
              </motion.div>
            </div>
          ...
          <div className="p-8 lg:p-12">
            <div className="flex justify-between items-center mb-8">
              ...
              <img src="/assets/p.png" alt="Logo" className="h-12" />
            </div>

            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-gray-900">Créer un compte Enseignant</h1>
              <p className="text-gray-600 mt-2">
                Rejoignez-nous et partagez votre savoir
              </p>
            </div>
              ...
              {formSections.map((section, idx) => (
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {section.fields.includes("sousCategorie") && categorie === "Faculté" && (
                      <div className="md:col-span-2">
                        <label className="text-sm font-medium text-gray-700 mb-1 block">
                        ...
                        <Select
                          ...
                          className="w-full !rounded-lg"
                          placeholder="Sélectionnez votre sous catégorie (optionnel)"
                        >
                          {enseignantSousOptions.map((option) => (
                    ...
                    {section.fields.includes("yearsOfExperience") && (
                      <div className="md:col-span-1">
                        <label className="text-sm font-medium text-gray-700 mb-1 block">
                          Années d'expérience
                        </label>
                        <input
                          ...
                          className="w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200"
                          placeholder="0"
                          required
                        />
                      </div>
                    ...
                    {section.fields.includes("additionalInfo") && (
                      <div className="md:col-span-1">
                        <label className="text-sm font-medium text-gray-700 mb-1 block">
...
export default RegisterEnseignantPage;
